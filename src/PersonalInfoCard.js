...
const q1 = {
  question: "",
  description: "",
  options: {"Already graduated.": "Graduated", "2021": "2021", "2022": "2022", "2023": "2023", "2024":"2024"}, placeholder: "Grad Year"
};
const q2 = {
...
function PersonalInfoCard(props) {
  useEffect(() => {
    if(dataChange) {
    const data = {'a1': a1, 'a2': a2, 'firstName': first, 'lastName': last, 'phone': phone}
    props.onUpdate(data);
    dataChange=false;
    }
  });
  ...
  return (
    <ThemeProvider theme={themeColor}>
      <Card className="income-card" id="income-card-mobile" style={{display: props.stepNum == 4 ? "" : "none"}}>
      ...
      />
          ...
          />
          <YesNo question={q2.question} description={q2.description}  onChange={(e) => updateA2(e)}/>
        </CardContent>
      </Card>
    </ThemeProvider>
  );
